...
CREATE TABLE COMUNIDADE (
    ...
    CONSTRAINT FK_COMUNIDADE_ESTADO FOREIGN KEY(ESTADO) REFERENCES ESTADO(SIGLA),
...
CREATE TABLE HABITANTE (
    ...
    CONSTRAINT FK_HABITANTE FOREIGN KEY(COMUNIDADE) REFERENCES COMUNIDADE(ID_COMUNIDADE) ON DELETE CASCADE,
...
CREATE TABLE CONTRATO (
    ...
    CONSTRAINT FK_CONTRATO_ESTADO FOREIGN KEY (ESTADO) REFERENCES ESTADO(SIGLA),
...
CREATE TABLE INTERLOCUTOR (
    ...
    CONSTRAINT FK_INTERLOCUTOR FOREIGN KEY(SUPERVISOR) REFERENCES DIRETOR_EMPRESA(RG) ON DELETE CASCADE,
